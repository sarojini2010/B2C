...
public interface Constant
{
    ...
    String CHILDHOMEIP="http://192.168.0.103/s2m-b2c/Api/child_home?child_id=10";
    String SessionDetailIp="http://192.168.0.103/s2m-b2c/Api/session_details?session_id=13";
